...
Ext.define('Ext.ux.datetime.DateTime', {  
    ...
    renderTpl: [  
        '<div id="{id}-innerEl" role="grid">',  
            ...
            '<tpl if="showToday">',  
                //添加一个确认按钮渲染  
              // '<div id="{id}-footerEl" role="presentation" class="{baseCls}-footer">{%this.renderOkBtn(values, out)%}{%this.renderNowBtn(values, out)%}{%this.renderTodayBtn(values, out)%}</div>',  
    ...
    beforeRender: function () {  
       ...
       // me.nowBtn = new Ext.button.Button({  
        ...
        //    tooltip: '现在',  
        //    tooltipType:'title',  
         //   handler:me.nowHandler,//现在按钮的事件委托  
         //   scope: me  
        //});  
        me.callParent();  
    },  
