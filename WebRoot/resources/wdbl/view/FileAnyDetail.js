 ...
 * 
 */
 Ext.define('Wdbl.view.FileAnyDetail', {extend : 'Ext.panel.Panel', requires : ['Ext.*', 'Wdbl.utils.*'],
   		p_id : null,
   	 	type : null,
	        ...
	        function editStore() {
	         ...
	         var editForm = Ext.create('Ext.form.FormPanel',{
	            ...
	            items: [{xtype:"hiddenfield",name: "id"},
	                    ...
	                    {name: "agent", fieldLabel: '办理人', labelAlign: 'right', allowBlank:false, xtype : "textfield"},
