Ext.define('Wdbl.form.op.submitForm',{
    ...
    initComponent: function () {
		...
		var officeLeader_job = combobox_common.officeLeaderJob('officeLeader_job','');
	 	...
	 	var draft_op = Ext.create('Ext.form.TextArea', {name: "draft_op", fieldLabel: '拟办意见',labelAlign: 'right',allowBlank:true,maxLength:40,colspan: 5});
		...
		me.form_submit = Ext.create('Ext.form.FormPanel',{
            ...
            items: [filed_id,sendtype,sendLeader,draft_op],
	        buttons: [{
	            text: '保存',
	            formBind:true,
	            monitorValid:true,
