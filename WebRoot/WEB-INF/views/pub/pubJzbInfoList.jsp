...
<html>
	<head>
        ...
        Ext.onReady(function () {
			...
			store_1.on('beforeload', function (store1, options) {
        		var new_params = { name: s_filed_1.getValue(),property:'id',direction:'asc'};//name与pubJzbInfo实体类中属性对应
            ...
            this.gridpanel = Ext.create("Ext.grid.Panel", {
                ...
                columns: [
                    ...
                    { header: "值班日期", dataIndex: "zbDate", sortable: true,flex : 5 },
                    ...
                    { header: "专电", dataIndex: "specialPhone", sortable: true ,flex : 5},
		 ...
		 gridpanel.setHeight(document.getElementById("pubJzbInfoGrid").offsetHeight);
     
	
		 function createForm(purl,load,id){
		 	var filed_id = Ext.create('Ext.form.Hidden', {name: "id", fieldLabel: 'ID'});
		 	var filed_zbDate = Ext.create('Ext.form.Date', {name: "zbDate", fieldLabel: '值班日期',labelAlign: 'right',allowBlank:false});
			...
			var form_1 = Ext.create('Ext.form.FormPanel',{
	            ...
	            items: [filed_id,filed_zbDate,filed_name,filed_job,filed_cityPhone,filed_specialPhone,filed_phone,filed_address],
		        buttons: [{
		            text: '保存',
		            formBind:true,
		            monitorValid:true,
		...
		//增加
		function add(){
			createForm('pubJzbInfo/add.do',false,null);
		}
		//编辑
		function edit(){
            ...
            if (selModel.hasSelection()) {
                  ...
                  if(selected.length==1&&selected[0].data.id!=null){
                  		createForm('pubJzbInfo/update.do',true,selected[0].data.id);
                  }else{
	...
	<body>  
		<div id="pubJzbInfoGrid" style="height: 100%;width: 100%;"></div> 
	</body>
</html>