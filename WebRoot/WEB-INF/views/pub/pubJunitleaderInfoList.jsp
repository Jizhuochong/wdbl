...
<html>
	<head>
        ...
        Ext.onReady(function () {
            ...
            this.store_1 = Ext.create("Ext.data.JsonStore", {
                ...
                proxy: {
                    type: "ajax",
                    url: "pubJunitleaderInfo/list.do",
            ...
            this.gridpanel = Ext.create("Ext.grid.Panel", {
                ...
                autoHeight:true,
                title: "菜单列表",
                renderTo: "pubJunitleaderInfoGrid",
                frame: true,
                store: store_1,
                loadMask:true,
                columnLines:true,
                ...
                columns: [
                    ...
                    { header: "联系电话", dataIndex: "phone", sortable: true ,flex : 5},
                    { header: "单位名称", dataIndex: "unit", sortable: true ,flex : 5},
                    { header: "单位电话", dataIndex: "unitCall", sortable: true ,flex : 5},
                    { header: "家庭住址", dataIndex: "address", sortable: true ,flex : 5}
                ],
		 ...
		 gridpanel.setHeight(document.getElementById("pubJunitleaderInfoGrid").offsetHeight);
		 ...
		 function createForm(purl,load,id){
		 	...
		 	var filed_phone = Ext.create('Ext.form.Text', {name: "phone", fieldLabel: '联系电话',labelAlign: 'right',allowBlank:false});
		 	...
		 	var filed_address = Ext.create('Ext.form.Text', {name: "address", fieldLabel: '家庭住址',labelAlign: 'right',allowBlank:false});
			...
			var form_1 = Ext.create('Ext.form.FormPanel',{
	            ...
	            items: [filed_id,filed_name,filed_job,filed_phone,filed_unit,filed_unitCall,filed_address],
		        buttons: [{
		            text: '保存',
		            formBind:true,
		            monitorValid:true,
		    ...
		    if(load ==true,id!=null){
	    		form_1.getForm().load({
			    	url: 'pubJunitleaderInfo/loadBean.do',
				    params: {
				        id: id
				    },
				    failure: function(form, action) {
		...
		//增加
		function add(){
			createForm('pubJunitleaderInfo/add.do',false,null);
		}
		//编辑
		function edit(){
            ...
            if (selModel.hasSelection()) {
                  ...
                  if(selected.length==1&&selected[0].data.id!=null){
                  		createForm('pubJunitleaderInfo/update.do',true,selected[0].data.id);
                  }else{
            ...
            if (selModel.hasSelection()) {
                Ext.Msg.confirm("警告", "确定要删除吗？", function (button) {
                    if (button == "yes") {
				        ...
				        Ext.Ajax.request({
				            url: 'pubJunitleaderInfo/delete.do',
				            method: "post",
	...
	<body>  
		<div id="pubJunitleaderInfoGrid" style="height: 100%;width: 100%;"></div> 
	</body>
</html>