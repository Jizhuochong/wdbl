...
<html>
	<head>
        ...
        Ext.onReady(function () {
            ...
            this.store_1 = Ext.create("Ext.data.JsonStore", {
                ...
                proxy: {
                    type: "ajax",
                    url: "pubProvinceleaderInfo/list.do",
			...
			store_1.on('beforeload', function (store1, options) {
        		var new_params = { name: s_filed_1.getValue(),property:'id',direction:'asc'};//name与pubProvinceleaderInfo实体类中属性对应
            ...
            this.gridpanel = Ext.create("Ext.grid.Panel", {
                ...
                autoHeight:true,
                title: "菜单列表",
                renderTo: "pubProvinceleaderInfoGrid",
                frame: true,
                store: store_1,
                loadMask:true,
                columnLines:true,
                ...
                columns: [
                    ...
                    { header: "省份", dataIndex: "province", sortable: true ,flex : 5},
                    { header: "手机", dataIndex: "phone", sortable: true ,flex : 5},
                    { header: "地址", dataIndex: "address", sortable: true ,flex : 5}
                ],
		 ...
		 gridpanel.setHeight(document.getElementById("pubProvinceleaderInfoGrid").offsetHeight);
		 ...
		 function createForm(purl,load,id){
		 	...
		 	var filed_unitCall = Ext.create('Ext.form.Text', {name: "unitCall", fieldLabel: '市电',labelAlign: 'right',allowBlank:false});
		 	var filed_province = Ext.create('Ext.form.Text', {name: "province", fieldLabel: '省份',labelAlign: 'right',allowBlank:false});
		 	var filed_phone = Ext.create('Ext.form.Text', {name: "phone", fieldLabel: '手机',labelAlign: 'right',allowBlank:false});
		 	var filed_address = Ext.create('Ext.form.Text', {name: "address", fieldLabel: '地址',labelAlign: 'right',allowBlank:false});
			...
			var form_1 = Ext.create('Ext.form.FormPanel',{
	            ...
	            items: [filed_id,filed_name,filed_job,filed_unitCall,filed_province,filed_phone,filed_address],
		        buttons: [{
		            text: '保存',
		            formBind:true,
		            monitorValid:true,
		    ...
		    if(load ==true,id!=null){
	    		form_1.getForm().load({
			    	url: 'pubProvinceleaderInfo/loadBean.do',
				    params: {
				        id: id
				    },
				    failure: function(form, action) {
		...
		//增加
		function add(){
			createForm('pubProvinceleaderInfo/add.do',false,null);
		}
		//编辑
		function edit(){
            ...
            if (selModel.hasSelection()) {
                  ...
                  if(selected.length==1&&selected[0].data.id!=null){
                  		createForm('pubProvinceleaderInfo/update.do',true,selected[0].data.id);
                  }else{
            ...
            if (selModel.hasSelection()) {
                Ext.Msg.confirm("警告", "确定要删除吗？", function (button) {
                    if (button == "yes") {
				        ...
				        Ext.Ajax.request({
				            url: 'pubProvinceleaderInfo/delete.do',
				            method: "post",
	...
	<body>  
		<div id="pubProvinceleaderInfoGrid" style="height: 100%;width: 100%;"></div> 
	</body>
</html>