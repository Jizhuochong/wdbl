...
<html>
	<head>
		...
		Ext.onReady(function () {
			...
			grid_store.on('beforeload', function (store1, options) {
        		var new_params = { docType:11,title: s_file_title.getValue()+'##true'};
          ...
          gridpanel.setHeight(document.getElementById("grid_fileother").offsetHeight); 
	...
	<body>  
		<div id="grid_fileother" style="height: 100%;width: 100%;"></div> 
	</body>
</html>