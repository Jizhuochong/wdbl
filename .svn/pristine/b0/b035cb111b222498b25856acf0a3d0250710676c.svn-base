...
<html>
	<head>
        ...
        Ext.onReady(function () {
			...
			grid_store.on('beforeload', function (store1, options) {
        		var new_params = { docType:6,title: s_file_title.getValue()+'##true'};
            ...
            var gridpanel = Ext.create("Ext.grid.Panel", {
                ...
                tbar: [	grid_common.bu('领导意见',f_leaderop),
          ...
          gridpanel.setHeight(document.getElementById("grid_fileofficeinner").offsetHeight); 
	...
	<body>  
		<div id="grid_fileofficeinner" style="height: 100%;width: 100%;"></div> 
	</body>
</html>