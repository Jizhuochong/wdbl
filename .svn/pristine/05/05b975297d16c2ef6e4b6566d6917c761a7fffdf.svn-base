...
<html>
		...
		<script type="text/javascript">
         Ext.onReady(function () {
			...
			grid_store.on('beforeload', function (store1, options) {
        		var new_params = { docType:4, title: s_file_title.getValue()+'##true'};
            ...
            var gridpanel = Ext.create("Ext.grid.Panel", {
                ...
                autoHeight:true,
                title: "公安部正式文件",
                renderTo: "grid_filepoliceofficial",
                frame: true,
                store: grid_store,
                loadMask:true,
                columnLines:true,
                ...
                tbar: [
                		grid_common.bu('打印阅批单',f_print),grid_common.bu('领导意见',f_leaderop),
          ...
          gridpanel.setHeight(document.getElementById("grid_filepoliceofficial").offsetHeight); 
	...
	<body>  
		<div id="grid_filepoliceofficial" style="height: 100%;width: 100%;"></div> 
	</body>
</html>