...
<html>
	<head>
        ...
        Ext.onReady(function () {
			...
			grid_store.on('beforeload', function (store1, options) {
        		var new_params = { docType:7,title: s_file_title.getValue()+'##true'};
            ...
            var gridpanel = Ext.create("Ext.grid.Panel", {
                ...
                autoHeight:true,
                title: "领导交办件",
                renderTo: "grid_fileleaderassigned",
                frame: true,
                store: grid_store,
                loadMask:true,
                columnLines:true,
                ...
                tbar: [
                		grid_common.bu('领导意见',f_leaderop),
          ...
          gridpanel.setHeight(document.getElementById("grid_fileleaderassigned").offsetHeight); 
	...
	<body>  
		<div id="grid_fileleaderassigned" style="height: 100%;width: 100%;"></div> 
	</body>
</html>