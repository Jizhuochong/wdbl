...
<html>
	<head>
		...
		<script type="text/javascript" src="resources/wdbl/over_file/init.js"></script>
		
	</head>
	<body>

		<div id="$main_over_tab" style="height: 100%;width: 100%;"></div>
		<OBJECT ID='create_over_file' style='WIDTH:0px; HEIGHT:0px' classid='clsid:385EC1A7-F1B2-446B-B289-4DC8DD4C935A' VIEWASTEXT></OBJECT>
		<Table>
	</body>
</html>