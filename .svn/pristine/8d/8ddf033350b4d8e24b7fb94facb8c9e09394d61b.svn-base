...
<html>
		...
		<script type="text/javascript">
          Ext.onReady(function () {
			...
			grid_store.on('beforeload', function (store1, options) {
        		var new_params = { docType:9,title: s_file_title.getValue()+'##true'};
          ...
          gridpanel.setHeight(document.getElementById("grid_filedirectsend").offsetHeight); 
	...
	<body>  
		<div id="grid_filedirectsend" style="height: 100%;width: 100%;"></div> 
	</body>
</html>