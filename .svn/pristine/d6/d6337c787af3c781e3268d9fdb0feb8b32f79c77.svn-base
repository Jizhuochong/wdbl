...
<html>
	<head>
        ...
        Ext.onReady(function () {
		 ...
		 gridpanel.setHeight(document.getElementById("pubZbsInfoGrid").offsetHeight);
		 ...
		 function createForm(purl,load,id){
			...
			var form_1 = Ext.create('Ext.form.FormPanel',{
	            ...
	            items: [filed_id,filed_name,filed_unitCall],
		        buttons: [{
		            text: '保存',
		            formBind:true,
		            monitorValid:true,
		...
		//增加
		function add(){
			createForm('pubZbsInfo/add.do',false,null);
		}
		//编辑
		function edit(){
            ...
            if (selModel.hasSelection()) {
                  ...
                  if(selected.length==1&&selected[0].data.id!=null){
                  		createForm('pubZbsInfo/update.do',true,selected[0].data.id);
                  }else{
	...
	<body>  
		<div id="pubZbsInfoGrid" style="height: 100%;width: 100%;"></div> 
	</body>
</html>