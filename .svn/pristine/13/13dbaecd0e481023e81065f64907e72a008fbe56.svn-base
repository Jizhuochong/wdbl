...
<html>
	<head>
        ...
        Ext.onReady(function () {
			...
			grid_store.on('beforeload', function (store1, options) {
        		var new_params = { docType:2, title: s_file_title.getValue()+'##true'};
            ...
            var gridpanel = Ext.create("Ext.grid.Panel", {
                ...
                tbar: [
                		...
                		grid_common.bu('拟办',f_draft),	grid_common.bu('办结',f_end),
                		{xtype : "tbfill"},
                		s_file_title,grid_common.bu_search(grid_store)
                ] ,
                bbar: grid_common.toolbar(grid_store)
            });
          gridpanel.setHeight(document.getElementById("grid_filewidesend").offsetHeight); 
	...
	<body>  
		<div id="grid_filewidesend" style="height: 100%;width: 100%;"></div> 
	</body>
</html>